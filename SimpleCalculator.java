	...
	**********************************************/  
	...
	final int FRAME_WIDTH=350,FRAME_HEIGHT=350;  
	final int HEIGHT=35, WIDTH=35, H_SPACE=15,V_SPACE=15;  
	final int TOPX=35, TOPY=55;  
	///////////////////////////  
	...
	displayLabel.setBounds(tempX,y,245,HEIGHT);  
	...
	{  
	new SimpleCalculator("SimpleCalculator - pl.vistual");  
	}  
	}  
	...
	//////////////////////////////////////////  
	MyDigitButton(int x,int y, int width,int height,String cap, SimpleCalculator clc)  
	{  
	super(cap);  
	...
	MyOperatorButton(int x,int y, int width,int height,String cap, SimpleCalculator clc)  
	{  
	super(cap);  
	setBounds(x,y,width,height);  
	this.cl=clc;  
	...
	if(opText.equals("1/x"))  
	    ...
	    try  
	        ...
	        cl.displayLabel.setText(SimpleCalculator.getFormattedText(tempd));}  
	...
	/////////////////////////////////  
	MyMemoryButton(int x,int y, int width,int height,String cap, SimpleCalculator clc)  
	{  
	super(cap);  
	setBounds(x,y,width,height);  
	this.cl=clc;  
	...
	case 'R':   
	    cl.displayLabel.setText(SimpleCalculator.getFormattedText(cl.memValue));break;  
	case 'S':  
	    cl.memValue=0.0;  
	case '+':   
	...
	MySpecialButton(int x,int y, int width,int height,String cap, SimpleCalculator clc)  
	{  
	super(cap);  
	setBounds(x,y,width,height);  
	this.cl=clc;  
